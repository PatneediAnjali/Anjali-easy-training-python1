...
'''#write a program after creating a list with even numbers with in the range 1 to 15,
now apply lambda function and create a new list which should have square roots of the elements from math import sqrt
L=(2,4,6,8,10,12,14)
